giClient.core.customNamespace('blog.comment.modifying.base');

giClient.custom.blog.comment.modifying.base.Modifying = function()
{
    ...
    let showResponse = function(data)
    {
        ...
        let {success = 0, redirectURI = '', messages = []} = data;
